...
class LearningProcess:
    ...
    def update_dimensions(self, new_state_dim, new_action_dim):
        ...
        IMPORTANT: For tabular Q-learning, we preserve existing Q-values for states
        that are still valid. New states/actions get initialized to 0.
        """
        ...
        if self.use_neural_network:
            # For neural network, create new network (architecture changes with input/output size)
...
class Simulation:
    ...
    def __init__(self,
        ...
        self.learning_process = LearningProcess(state_dim=state_dim, action_dim=action_dim, **config)
    ...
    def reset_simu(self):
        ...
        # Update learning process dimensions if needed (preserves Q-values!)
        state_dim = self.creature.num_segments
        action_dim = 3 * self.creature.num_segments + (0 if self.creature.fixed_segments else 2)
        ...
        # Return the initial state (only active segments)
    ...
    def _apply_action(self, action, prev_num_segments):
        ...
        if not self.creature.fixed_segments:
            add_action_idx    = prev_num_segments * 3
            remove_action_idx = prev_num_segments * 3 + 1
    ...
    def run_training(self):
        ...
        for ep in range(self.episodes + 1):
            ...
            for step in range(self.max_steps):
                ...
                # Update Q-values ONLY if dimensions didn't change
...
def main():
    ...
    print("=" * 60)
    print("   AQUATIC CREATURE TRAINER - V14")
    print("=" * 60)
    print()
