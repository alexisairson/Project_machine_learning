...
def visualize(checkpoints, target_angle=0.0, duration=10.0):
    ...
    pygame.display.set_caption("Aquatic Evolution V14 - Visualizer (with Thrust/Drag vectors)")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("   AQUATIC CREATURE VISUALIZER - V14")
    print("=" * 60)
    ...
    if not saved_files:
        ...
        print("Please run 'aquatic_evolution_qlearning_V14_corrected.py' first.")
    else:
