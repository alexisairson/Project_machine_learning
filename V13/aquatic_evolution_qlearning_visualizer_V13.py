...
def visualize(checkpoints, target_angle=0.0, duration=10.0):
    ...
    pygame.display.set_caption("Aquatic Evolution V11 - Visualizer")
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("   AQUATIC CREATURE VISUALIZER - V11")
    print("=" * 60)
    ...
    if not saved_files:
        ...
        print("Please run 'aquatic_evolution_qlearning_training_V11.py' first.")
    else:
        ...
        try:
            ...
            if 0 <= idx < len(saved_files):
                ...
                print(f"Target: {angle}掳, Duration: {duration}s")
